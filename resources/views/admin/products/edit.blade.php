        ...
        <form role="form" method="POST" action="{{ route('products.update',$product->id) }}"
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input required value="{{ $product->name }}" type="text" class="form-control" name="name" id="name"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="0" required name="price" min="0"
                        value="{{ $product->price }}" step="0.01" title="price" pattern="^\d+(?:\.\d{1,2})?$">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="0" name="market_price" min="0"
                        value="{{ $product->market_price }}" step="0.01" title="market_price"
                        pattern="^\d+(?:\.\d{1,2})?$">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="enter product quantity" required
                        name="quantity" min="0" value="{{ $product->quantity }}" title="quantity">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="enter product min_order_qty" required
                        name="min_order_qty" min="0" value="{{ $product->min_order_qty  }}" title="min_order_qty">
                </div>

                <div class="form-group">
                    <label for="unit">Unit</label>
                    <input value="{{ old('unit') }}" type="text" class="form-control" name="unit" id="unit"
                        placeholder="Enter product unit" value="{{ $product->unit  }}">
                </div>
                <div class="form-group">
                    <label for="image">Current Image</label> <br>
                    <img height="50" width="auto" src={{ asset("storage/products/".$product->image) }} alt="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select required class="form-control select2" name="categories[]" multiple="multiple"
                        ...
                        <option @if($product->categories->containsStrict('id', $category->id)) selected="selected"
                            @endif
