            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input required value="{{ old('name') }}" type="text" class="form-control" name="name" id="name"
                        placeholder="Enter shop name" value="{{ old('name') }}">
                </div>

                <div class="form-group">
                    <label for="trade_license">Trade License No*</label>
                    <input required value="{{ old('trade_license') }}" type="text" class="form-control"
                        name="trade_license" id="trade_license" placeholder="Enter Trade License No">
                </div>

                <div class="form-group">
                    <label for="website_url">Website URL*</label>
                    <input required value="{{ old('website_url') }}" type="text" class="form-control" name="website_url"
                        id="website_url" placeholder="Enter Website URL">
                </div>

                <div class="form-group">
                    <label for="email">Shop Business email*</label>
                    <input required value="{{ old('email') }}" type="email" class="form-control" name="email" id="email"
                        placeholder="Enter Shop Business email">
                </div>

                <div class="form-group">
                    <label for="phone">Phone Number*</label>
                    <input required value="{{ old('phone') }}" type="phone" class="form-control" name="phone" id="phone"
                        placeholder="Enter Shop Business phone" maxlength="11">
                </div>

                <div class="form-group">
                    <label for="addr_1">Address Line 1*</label>
                    <input required value="{{ old('addr_1') }}" type="text" class="form-control" name="addr_1"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="addr_2" id="addr_2"
                        placeholder="Enter Shop Business address line 2">
                </div>

                <div class="form-group">
                    <label for="trade_license_file">Trade License file (pdf or image) max file size 5MB*</label>
                    <input required type="file" class="form-control" name="trade_license_file"
