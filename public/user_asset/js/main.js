$(document).ready(function() {
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='user_asset/img/banner/prev.png'>",
            "<img src='user_asset/img/banner/next.png'>"
        ],
        dots: false
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='user_asset/img/product/prev.png'>",
            "<img src='user_asset/img/product/next.png'>"
        ],
        dots: false
    });
